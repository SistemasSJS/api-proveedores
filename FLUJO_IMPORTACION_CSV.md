...
### 1. SubirCsvPage 📁
**Ruta**: `/pages/proveedor/csv-import/csv`  
...
**Backend Endpoint**: `POST /api/proveedor/{id}/csv-import`  
...
### 2. TablaPreviewPage 📋
**Ruta**: `/pages/proveedor/csv-import/preview`  
...
**Backend Endpoint**: `POST /api/proveedor/{id}/csv-import/confirm`  
**Request**:
```typescript
{
  audit_id: number;
