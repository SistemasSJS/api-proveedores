...
Route::middleware(['auth:sanctum'])->group(function () {
  Route::prefix('notifications')->group(function () {
    ...
    // Nuevas rutas para agrupación por tipos
    Route::get('/grouped', [NotificationController::class, 'getGroupedByType'])->middleware(['audit']);
    Route::get('/resumen', [NotificationController::class, 'resumen'])->middleware(['audit']);
    Route::get('/tipo/{tipoId}', [NotificationController::class, 'getByTipo'])->middleware(['audit']);
    Route::patch('/tipo/{tipoId}/read', [NotificationController::class, 'markTipoAsRead'])->middleware(['audit']);
    Route::delete('/{notificationId}', [NotificationController::class, 'destroy'])->middleware(['audit']);
  });
});
