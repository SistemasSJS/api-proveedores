...
class ActualizarEstadoPagadoRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'comprobante_pago.file' => 'Debe cargar un archivo válido',
            'comprobante_pago.mimes' => 'El comprobante debe ser PDF o imagen (JPG, PNG)',
            'comprobante_pago.max' => 'El archivo no debe superar los 10MB',
